...
const LoginPage = () => {
	...
	return (
		<form onSubmit={handleLogin} className={styles.form}>
			...
			<TextField className={styles.field} variant="outlined" onChange={handleChange} value={formValue.email}
					   type="email" name="email"/>
			<TextField className={styles.field} variant="outlined" onChange={handleChange} value={formValue.password}
